...
public class EarthquakeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        earthquakes.add(new Earthquake( "7.2", "Rio de Janerio", "Feb 2, 2016") );
        earthquakes.add(new Earthquake( "7.2", "Paris", "Feb 2, 2016") );
        earthquakes.add(new Earthquake( "7.2", "Dhaka", "Feb 2, 2016") );
        earthquakes.add(new Earthquake( "7.2", "Chittagong", "Feb 2, 2016") );
        earthquakes.add(new Earthquake( "7.2", "Cairo", "Feb 2, 2016") );
